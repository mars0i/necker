...
Various sorts of information in this data gets used by the visual system in our eye, optic nerve, and brain in this process.  The Necker cube illustrates one aspect of this process: they eye sees an object in the world that is literally two-dimensional, but we tend to experience as three-dimensional.  There are two different ways that humans experience the Necker cube figure as three dimensional.  (See the web page mentioned above, or TUTORIAL below.)  This program provides a simple model of a process that could take place just before a Necker cube is experienced as three-dimensional, or when the perception of the figure "flips" from one perspective to another.

More specifically, we can think of the two three-dimensional views of the Necker cube as "hypotheses" about what three-dimensional structure one is looking at.  This program models a process by which these two different hypotheses compete with each other.  It is a model of a process by which a visual system might work out a consistent
